          ...
          let emailHtml = `
            ...
            <body style="background-color: #f4f4f4; margin: 0 !important; padding: 0 !important;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <!-- HERO -->
                    <tr>
                        <td bgcolor="#3f51b5" align="center" style="padding: 0px 10px 0px 10px;">
                            <table border="0" cellpadding="0" cellspacing="0" width="480">
                                <tr>
                                            ...
                                            <tr>
                                                <td bgcolor="#ffffff" align="center" style="padding: 20px 30px 60px 30px;">
                                                    <table border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td align="center" style="border-radius: 3px;" bgcolor="#3f51b5"><a
                                                                    href="http://localhost:3000/reset/${token}" target="_blank"
                                ...
                                <tr>
                                    <td bgcolor="#111111" align="left"
                                        ...
                                        <p style="margin: 0;"><a href="http://litmus.com" target="_blank"
                                                style="color: #3f51b5;">See how easy it is to get started</a></p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="480">
                                ...
                                <tr>
                                    <td bgcolor="#C6C2ED" align="center"
                                        ...
                                        <p style="margin: 0;"><a href="http://litmus.com" target="_blank"
                                                style="color: #3f51b5;">We&rsquo;re here, ready to talk</a></p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="480">
                                ...
                                <tr>
                                    <td bgcolor="#f4f4f4" align="center"
                                        style="padding: 15px 30px 30px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 400; line-height: 18px;">
                                        <p style="margin: 0;">123 Main St, Some Place, FL 12345</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
            ...
            try {
                ...
                let info = await transporter.sendMail({
                    from: '"Mern Stack Passport Auth" <yeasir01@gmail.com>',
                    to: email,
